...
const TopbarNavDashboards = () => (
    <UncontrolledDropdown className="topbar__nav-dropdown">
        ...
        <DropdownMenu className="topbar__nav-dropdown-menu dropdown__menu">
            ...
            <DropdownItem>
                <TopbarNavLink title="Dashboard E-commerce" icon="store"
                               route="/dashboard_e_commerce"/>
            </DropdownItem>
            <DropdownItem>
                <TopbarNavLink title="Dashboard Fitness" icon="heart-pulse"
            ...
            <DropdownItem>
                <TopbarNavLink title="Dashboard Booking" icon="apartment" newLink
