    ...
    <Col md={12} lg={6}>
        <Card>
            <CardBody>
                ...
                <h4 className="subhead">Nullam quis risus eget urna mollis ornare vel eu leo. Cum
                    sociis natoque
                    penatibus.
                </h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum
                    ornare dolor, quis
                    ullamcorper ligula sodales at. Nulla tellus elit, varius non commodo eget,
                    mattis vel eros. In
                    sed ornare nulla. Nullam quis risus eget urna mollis ornare vel eu leo. Cum
