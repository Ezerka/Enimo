        ...
        <Card>
            <CardBody>
                <div className="card__title">
                    ...
                    <h5 className="subhead">Use default buttons with property <span
                        className="red-text">size</span>
                    </h5>
                </div>
                <h5 className="bold-text">Small buttons</h5>
                <div className="card__title">
                    <h5 className="subhead">Use the modifier <span className="red-text">sm</span>
                    </h5>
                </div>
                <ButtonToolbar>
                ...
                <div className="card__title">
                    <h5 className="subhead">Use the modifier <span className="red-text">lg</span>
                    </h5>
                </div>
                <ButtonToolbar>
