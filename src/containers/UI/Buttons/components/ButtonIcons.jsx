    ...
    <Col md={12} lg={6} xl={6}>
        <Card>
            <CardBody>
                ...
                <div className="card__title">
                    <h5 className="subhead">Use default buttons with class <span
                        className="red-text">icon</span>,
                ...
                <ButtonToolbar>
                    ...
                    <Button className="icon icon--right" color="primary" outline>
                        <p>Settings <SendIcon/></p></Button>
                    <Button className="icon" color="primary"><p><SettingsIcon/> Settings</p>
                    </Button>
                    <Button className="icon" color="success"><p><ThumbUpOutlineIcon/> Success</p>
                    </Button>
                    <Button className="icon" color="warning"><p><CommentAlertOutlineIcon/> Danger
                    </p></Button>
                    <Button className="icon" color="danger"><p><CloseCircleOutlineIcon/> Warning</p>
                    </Button>
                </ButtonToolbar>
