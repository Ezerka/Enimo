                ...
                <Card>
                    <CardBody>
                        <div className="card__title">
                            ...
                            <h5 className="subhead">Use FullWideNotification with color: <span
                                className="red-text">primary</span>,
                                <span className="red-text">success</span>, <span
                                    className="red-text">warning</span>,
                                <span className="red-text">danger</span>
                            </h5>
                        </div>
                        <ButtonToolbar>
                            <Button color="primary"
                                    onClick={() => this.show('primary')}>Primary</Button>
                            <Button color="success"
                                    onClick={() => this.show('success')}>Success</Button>
                            <Button color="warning"
                                    onClick={() => this.show('warning')}>Warning</Button>
                            <Button color="danger"
                                    onClick={() => this.show('danger')}>Danger</Button>
                        </ButtonToolbar>
                    </CardBody>
                </Card>
            </Col>
