...
const WizardFormOne = ({handleSubmit, previousPage}) => (
    <form className="form form--horizontal wizard__form" onSubmit={handleSubmit}>
        ...
        <div className="form__form-group">
            ...
            <p className="wizard__description">Agreement offending commanded my an. Change wholly
                say why eldest
                period.
            </p>
        </div>
        <div className="form__form-group">
            ...
            <p className="wizard__description">Are projection put celebrated particular unreserved
                joy unsatiable its.
                In
        ...
        <ButtonToolbar className="form__button-toolbar wizard__toolbar">
            <Button color="primary" type="button" className="previous"
