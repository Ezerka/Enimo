            ...
            <div className="inbox__email inbox__content">
                <div className="inbox__email-header">
                    <div className="inbox__email-left">
                        <button className="inbox__email-back" onClick={onBack}><ArrowLeftIcon/>
                        </button>
                ...
                <div className="inbox__email-reply">
                    ...
                    {!this.state.quickReply ?
                        <p className="inbox__email-reply-placeholder">Click here
                            to <span>reply</span></p>
                        :
                        <div>
                            <button className="inbox__email-reply-close"
                                    onClick={this.onQuickReplyClose}>
                                <CloseIcon/>
                            </button>
