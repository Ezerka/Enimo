...
const ProfileActivities = () => (
    <div>
        <ProfileActivity img={Ava1} date="1 min ago" name="Lora Kolly">
            <p>Dependent certainty off discovery him his tolerably offending. Ham for attention
                remainder sometimes
        ...
        <ProfileActivity img={Ava1} date="3 hours ago" name="Anna Bro">
            <p>Dependent certainty off discovery him his tolerably offending. Ham for attention
                remainder sometimes
                additions recommend fat our. Dependent certainty off discovery him his tolerably
                offending. Ham for
