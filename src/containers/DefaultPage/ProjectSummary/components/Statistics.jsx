    ...
    render() {
        return (
            <div className="project-summary__statistics">
                {this.state.update ?
                    <div className="project-summary__statistics-refresh"><LoadingIcon/></div> : ''}
                <Button className="project-summary__btn" outline size="sm" onClick={this.onUpdate}>Update
                    Data</Button>
                <div className="project-summary__statistic">
                    ...
                    <PieChart width={240} height={220}>
                        <Tooltip/>
                        <Pie data={this.state.data1} dataKey="value" cx={110} cy={110}
                ...
                <div className="project-summary__statistic">
                    ...
                    <PieChart width={240} height={250}>
                        <Tooltip/>
                        <Pie data={this.state.data2} dataKey="value" cx={110} cy={110}
                             innerRadius={60} outerRadius={80}
                             label/>
                        <Legend layout="vertical" verticalAlign="middle" wrapperStyle={style}/>
                    </PieChart>
