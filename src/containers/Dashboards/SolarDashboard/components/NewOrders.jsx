...
const DropDownMore = ({index, handleDeleteRow}) => (
    <UncontrolledDropdown className="dashboard__table-more">
        ...
        <DropdownMenu className="dropdown__menu">
            <Link
                to={`/dashboard_e_commerce/edit/${index}`}><DropdownItem>Edit</DropdownItem></Link>
...
const NewOrders = ({t, newOrder, onDeleteRow}) => (
    ...
    >
        ...
        <Link to="/e-commerce/catalog" className="dashboard__table-orders-link">All
            products <ChevronDownIcon/></Link>
    </Panel>
);
