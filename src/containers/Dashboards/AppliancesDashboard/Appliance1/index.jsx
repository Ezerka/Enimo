...
class Appliance1 extends React.Component {
    state = {
        appliance_1_live: [{
            device_active: 3,
            avg_consumption: 1,
    ...
    render() {
        return (
            <Container className="dashboard">
                ...
                <Row>
                    <LiveStatusText Data={this.state.appliance_1_live}/>
                    <UsageStatusText Data={this.state.appliance_1_usage}/>
                </Row>
                <Row>
                    <MachineConsumption/>
                </Row>
...
export default translate('common')(Appliance1);
