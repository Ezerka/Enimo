...
class MachineConsumption extends PureComponent {
    static propTypes = {
                ...
                <Card>
                    <CardBody>
                        <div className="card__title">
                            <h5 className="bold-text">{t('machine.consumption')}</h5>
                            <h5 className="subhead">Detailed Information about the consumption
                            </h5>
                        </div>
