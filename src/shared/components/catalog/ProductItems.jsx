                        ...
                        (
                            <div className="catalog-item" key={i}>
                                <Link className="catalog-item__link" to="/e-commerce/product_page">
                                    {item.new ? <img className="catalog-item__label" src={New}
                                                     alt="new"/> : ''}
                                    {item.sale ? <img className="catalog-item__label" src={Sale}
                                                      alt="sale"/> : ''}
                                    <div className="catalog-item__img-wrap">
                                        <img className="catalog-item__img" src={item.src}
                                    ...
                                    <div className="catalog-item__info">
                                        ...
                                        {item.colors.map((c, index) =>
                                            <span key={index} className="catalog-item__color"
                                                  style={{background: c}}/>)}
                                    </div>
                                </Link>
                            </div>
